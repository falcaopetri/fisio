...
<html>
    ...
    <body>
        ...
        <div id="show-avaliacao" class="content scaffold-show" role="main">
            ...
            <f:display bean="avaliacao" />
            <g:form resource="${this.avaliacao}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.avaliacao}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
