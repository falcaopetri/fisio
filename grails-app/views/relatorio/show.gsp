...
<html>
    ...
    <body>
        ...
        <div id="show-relatorio" class="content scaffold-show" role="main">
            ...
            <f:display bean="relatorio" />
            <g:form resource="${this.relatorio}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.relatorio}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
