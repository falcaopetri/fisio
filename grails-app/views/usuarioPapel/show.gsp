...
<html>
    ...
    <body>
        ...
        <div id="show-usuarioPapel" class="content scaffold-show" role="main">
            ...
            <f:display bean="usuarioPapel" />
            <g:form resource="${this.usuarioPapel}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.usuarioPapel}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
