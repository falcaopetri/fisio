...
<html>
    ...
    <body>
        ...
        <div id="show-ficha" class="content scaffold-show" role="main">
            ...
            <f:display bean="ficha" />
            <g:form resource="${this.ficha}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.ficha}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
